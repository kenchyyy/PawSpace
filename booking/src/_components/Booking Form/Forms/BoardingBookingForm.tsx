    ...
    >
      {({ pet, onChange, onScheduleChange, errors }) => {
        ...
        const handleDateChange = (type: 'checkIn' | 'checkOut', date: Date | null) => {
          onScheduleChange(type, date, type === 'checkIn' ? pet.check_in_time : pet.check_out_time);
        };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <TimeDropdown
                      ...
                      onChange={(time) => onScheduleChange('checkIn', parseDate(pet.check_in_date), time)}
                      unavailableTimes={unavailableTimes}
                  ...
                  <div className="space-y-2">
                    ...
                    <TimeDropdown
                      ...
                      onChange={(time) => onScheduleChange('checkOut', parseDate(pet.check_out_date), time)}
                      unavailableTimes={unavailableTimes}
                      disabled={!pet.check_out_date}
                      sameDayCheckInTime={pet.boarding_type === 'day' && pet.check_in_time ? pet.check_in_time : undefined}
                    />
