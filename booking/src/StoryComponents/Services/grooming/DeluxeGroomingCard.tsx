import { DeluxeGroomingCardProps } from "../types/groomingTypes";
import PriceTable from "../PriceTable";
import Inclusion from "../Inclusions";

const DeluxeGroomingCard: React.FC<DeluxeGroomingCardProps> = ({ details }) => {
...
export default DeluxeGroomingCard;