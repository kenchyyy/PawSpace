import { CatAccommodationCardProps } from "../types/accommodationTypes";

const CatAccommodationCard: React.FC<CatAccommodationCardProps> = ({ details }) => {
...
export default CatAccommodationCard;