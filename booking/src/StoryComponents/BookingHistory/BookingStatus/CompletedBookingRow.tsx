...
import { CompletedBookingRowProps } from '../types/bookingRowsTypes';
import { format } from 'date-fns';



const CompletedBookingRow: React.FC<CompletedBookingRowProps> = ({ booking, onViewDetails }) => {
    ...
    return (
        ...
        <td>
            {onViewDetails && <button onClick={() => onViewDetails(booking.bookingId)}>View Details</button>}
        </td>
        </tr>
    );
};
