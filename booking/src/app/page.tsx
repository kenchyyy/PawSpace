...
const PhoneIcon = () => (
  ...
  >
    <path
      fillRule='evenodd'
      d='M2.25 6.75A3 3 0 015.25 3.75h1.372c.86 0 1.61.586 1.94 1.454l.758 2.275a1.5 1.5 0 01-.159 1.488l-1.54 1.54a12.75 12.75 0 008.214 8.214l1.54-1.54a1.5 1.5 0 011.488-.159l2.275.758c.86.33 1.454 1.08 1.454 1.94v1.372a3 3 0 01-3 3H7.5a9 9 0 01-9-9V6.75z'
      clipRule='evenodd'
    />
  </svg>
);
...
const LocationIcon = () => (
  ...
  >
    <path
      fillRule='evenodd'
      d='M11.54 22.351l.07.04.028.016a.76.76 0 00.723 0l.028-.015.071-.041a8.717 8.717 0 001.353-.82c1.373-.887 2.844-2.062 4.215-3.362.867-.867 1.724-1.776 2.503-2.713.895-1.059 1.657-2.157 2.15-3.231C22.613 8.35 22.893 7.077 22.893 5.75a7.5 7.5 0 00-15 0c0 1.327.28 2.6.793 3.737.493 1.074 1.255 2.172 2.15 3.231.779.937 1.636 1.846 2.503 2.713.3.3.6.58.903.84l.054.045a9.72 9.72 0 011.347.819zm.877-2.129l.073-.045A8.216 8.216 0 0115.15 17.5c1.196-1.181 2.302-2.328 3.295-3.38.775-.81.996-1.042.845-1.328a4.5 4.5 0 00-8.991 0c-.15.286.07.518.845 1.328.993 1.052 2.1 2.199 3.295 3.38a8.216 8.216 0 011.66 1.077zM12 9a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z'
      clipRule='evenodd'
    />
  </svg>
);
  ...
  return (
    <section ref={ref} className={`relative py-20 px-8 ${className}`}>
      <div className='container mx-auto'>
        <h2
          className={`text-5xl font-bold text-center mb-12 ${titleColor} font-heading`}
        >
          {title}
        </h2>
  ...
  return (
    <div className='relative min-h-screen bg-gradient-to-b from-purple-950 via-indigo-900 to-black text-white font-sans overflow-hidden'>
      ...
      <ParallaxLayer
        ...
        alt='Space dog in UFO'
        className='opacity-90 scale-75 md:scale-75 scale-100'
        style={{ left: "70%", top: "-10%", width: "70%", height: "auto" }}
        objectFit='contain'
      />
      <ParallaxLayer
        src={imageUrls.spaceObject}
        speed={speedFastest + 0.2}
        alt='Spaceship'
        className='opacity-90 scale-30'
        style={{ right: "40%", top: "25%", width: "auto", height: "auto" }}
        objectFit='contain'
      />
                ...
                <div className='flex items-start'>
                  ...
                  <div className='ml-3 text-left'>
                    ...
                    <div className='text-gray-300 text-sm'>
                      2nd Floor, AMJB Building,
                      <br />
                      Aguinaldo Highway, Palico 4,
                      <br />
                      Imus, Philippines
                      <a
            ...
            >
              ...
              <div className='p-6'>
                ...
                <p className='text-gray-300 mb-4'>
                  Give your pet a home away from home with our premium boarding
                  services.
                </p>
                <button
            ...
            {[
              {
                ...
                description:
                  "Our experienced staff provides top-notch care for your pets.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Round-the-clock supervision to ensure your pet's safety.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Maintained facilities for your pet's comfort and health.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Individual care plans tailored to your pet's needs.",
                icon: (
                  <svg
