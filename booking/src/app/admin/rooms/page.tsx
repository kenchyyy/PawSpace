    ...
    return (
        <RefreshContext.Provider value={{ refreshRooms }}>
            <div className="flex flex-col w-full h-full">
                ...
                <nav className="flex gap-x-4 fixed h-14 w-full bg-violet-900 items-center p-4 text-white z-10">
                ...
                <div className="flex flex-row pt-14 h-full">
                    ...
                    <ScrollArea className="flex-1 w-full p-2">
                        <div className="bg-fuchsia-900 p-1 m-1 rounded-2xl text-white wrap-break-word w-fit">Note: Only pets under statuses "confirmed" and "ongoing" are reflected on a given date here.</div>
