        ...
        <div>
          ...
          <ul className="space-y-3 mb-6">
            <li className="flex items-start">
              ...
              <span className="text-gray-400">Friendly and professional pet care staff</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">✓</span>
              <span className="text-gray-400">Clean, secure, and pet-friendly facilities</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">✓</span>
              <span className="text-gray-400">All-day service from Monday to Sunday</span>
            </li>
          </ul>
        </div>

        {/* Contact and Info Section */}
        <div className="rounded-lg p-6 shadow text-gray-400">
          <h3 className="text-2xl font-semibold text-white mb-4">Visit or Contact Us</h3>
          <p className="mb-2">
